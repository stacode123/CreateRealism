package net.Realism.forge.content.trains.schedule;
...
public class AdvancedScheduleScreen extends AbstractSimiContainerScreen<AdvancedScheduleMenu> {
    ...
    protected void init() {
        ...
        int x = leftPos + 85;
        int y = topPos + 196;
        timeInput = new EditBox(font, x, y, 40, 12, Component.literal("Time"));
        timeInput.setValue("18:30");
    ...
    public int renderScheduleEntry(GuiGraphics graphics, ScheduleEntry entry, int yOffset, int mouseX, int mouseY,
        ...
        PoseStack matrixStack2 = graphics.pose();
        matrixStack2.pushPose();
        matrixStack2.translate(leftPos + 25, topPos + yOffset, 0);
        graphics.drawString(font, "18:30", 150, 9, 0xff_f2f2ee, false);
    ...
    protected int renderInput(GuiGraphics graphics, Pair<ItemStack, Component> pair, int x, int y, boolean clean,
        ...
        if (minSize == 100 && y == 5) {
            ...
            if (text != null) {
                String truncated = font.plainSubstrByWidth(text.getString(), 80);
